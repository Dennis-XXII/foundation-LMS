<x-layout>
    ...
    <form method="POST" action="{{ route('admin.students.store') }}" class="bg-white border rounded-lg shadow p-6 space-y-4">
        @csrf
        <div class="grid md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input name="student_id" class="w-full border rounded px-3 py-2" required>
            </div>
            <div>
