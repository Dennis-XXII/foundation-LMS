    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="lg:col-span-1">
            ...
            >
                ...
                <button type="submit" class="w-full py-2 bg-purple-900 text-white rounded hover:bg-purple-800 transition">
                    Whitelist ID
                </button>
            </form>
        </div>
        ...
        <div class="lg:col-span-2">
            <div class="bg-white border rounded-lg shadow overflow-hidden">
                <div class="bg-gray-50 px-6 py-3 border-b">
                    <h2 class="text-lg font-semibold text-gray-800">Currently Whitelisted (Pending Registration)</h2>
                </div>
                        ...
                        @forelse($whitelistedStudents as $eligible)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    ...
                                    @if(!$eligible->registeredStudent)
                                        <form action="{{ route('admin.students.wlDestroy', $eligible->id) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button class="text-rose-600 hover:text-rose-900">Remove</button>
                                        </form>
                                    @endif
                                </td>
                            </tr>
