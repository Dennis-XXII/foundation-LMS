...
<x-layout>
    ...
    <div class="mb-6 p-4 rounded-lg bg-gray-100 border border-gray-200">
        <h1 class="text-2xl font-semibold text-gray-800">Grading Submission</h1>
        ...
        <div>
            ...
            <div class="mt-1 flex items-center gap-2">
                <input
                    ...
                    class="w-20 border rounded px-2 py-1 text-sm @error("score") border-red-500 @enderror"
                />
...
{{ old("comment", $assessment->comment ?? "") }}</textarea
        ...
        <div>
            ...
            <input
                ...
                id="feedback_file"
                name="feedback_file"
                class="mt-1 block text-sm @error("feedback_file") border border-red-500 @enderror"
            />
            @error("feedback_file")
                <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
            @enderror
