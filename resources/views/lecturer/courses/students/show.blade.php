<x-layout>
    ...
    <section class="max-w-8xl mx-auto p-3 space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="md:col-span-1 space-y-6">
                ...
                >
                    ...
                    <div class="px-6 pb-6 relative">
                        ...
                        <div class="-mt-12 mb-4">
                            <div
                                class="h-24 w-24 rounded-full border-4 border-white bg-gray-100 flex items-center justify-center text-3xl font-bold text-gray-400 shadow-md"
                            >
                ...
                >
                    ...
                    <form
                        action="{{ route("lecturer.courses.students.destroy", ["course" => $course, "student" => $student]) }}"
                        method="POST"
                        onsubmit="
                            return confirm(
                                'Are you sure you want to remove {{ $student->name }} from this course? All their grades and submissions will be detached.',
                            );
                        "
                    >
                        @csrf
                        ...
                        <button
                            type="submit"
                            class="w-full text-left px-3 py-2 text-sm text-red-600 hover:bg-red-50 rounded border border-transparent hover:border-red-100 transition flex items-center gap-2"
                        >
                            <svg
                                class="w-4 h-4"
                                fill="none"
                                    ...
                                    @foreach ($assignments as $assignment)
                                        ...
                                        <tr class="hover:bg-gray-50 transition">
                                            ...
                                            <td class="px-6 py-4">
                                                ...
                                                @elseif ($isOverdue)
                                                    <span
                                                        class="inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-red-50 text-red-700"
                                                    >
                                                        Missing
                                                    </span>
                                                @else
        ...
        <a
            href="{{ route("lecturer.courses.students.index", $course) }}"
            class="bg-gray-50 hover:bg-gray-100 text-gray-700 px-4 py-2 rounded-lg text-sm font-medium transition border border-gray-300"
        >
