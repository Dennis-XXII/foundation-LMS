<x-layout title="Add Useful Link">
    <nav class="mb-2 text-sm text-gray-600 p-3" aria-label="Breadcrumb">
        <ol class="list-reset flex">
            ...
            <li class="text-black font-semibold">Add Link</li>
        </ol>
    </nav>
    ...
    <div class="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow border">
        <div class="bg-gray-100 rounded p-4 mb-6">
            <h1 class="text-2xl font-semibold text-gray-800">
                Add Useful Link — {{ $course->code }}
            </h1>
            <p class="text-sm text-gray-600">
                Create a new resource link for this course.
            </p>
        </div>
        ...
        <form
            method="POST"
            action="{{ route("lecturer.courses.useful_links.store", $course) }}"
            class="space-y-6"
        >
            @csrf
