<x-guest-layout>
    <div class="flex flex-col items-center justify-center min-h-screen bg-white px-4 py-10">
        ...
        <div class="w-full max-w-3xl">
            <!-- Title -->
            <h1 class="text-2xl font-bold text-center text-gray-900 mb-8">Create Student Account</h1>
            ...
            <div class="w-full bg-gray-50 border border-[#7D3C98] rounded-xl p-6 md:p-8">
                <form method="POST" action="{{ route('register.student') }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Student ID -->
                        <div>
                            <label for="student_id" class="block text-gray-800 mb-2">Student ID</label>
