        ...
        <div class="w-full max-w-3xl">
            ...
            >
                ...
                >
                    ...
                    @if ($errors->any())
                        <div
                            class="bg-red-100 text-red-800 p-4 rounded-md mb-6"
                        >
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Name -->
                        <div>
                            <label for="name" class="block text-gray-800 mb-2">
                                Name
                            </label>
                            <input
                                type="text"
                    ...
                    <!-- Two Column Layout for Mentor ID (previously mentor_id) and Faculty -->
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="flex items-center mt-6">
                        <input
                            ...
                            id="terms"
                            name="terms"
                            class="w-5 h-5 text-purple-500 border-[#9B59B6] rounded focus:ring-purple-400"
                            required
                        />
            ...
            <div class="mt-6 text-center">
                <p class="text-gray-700">
                    ...
                    <a
                        href="{{ route("login") }}"
                        class="text-[#7D3C98] hover:text-[#815494]"
                    >
                        Log in
                    </a>
                </p>
