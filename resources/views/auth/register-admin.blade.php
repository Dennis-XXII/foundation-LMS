    ...
    <div class="flex justify-center items-center min-h-screen">
        ...
        >
            ...
            >
                ...
                <h3
                    class="form-title text-center text-2xl font-bold text-gray-800 mb-6"
                >
                    Admin Registration
                </h3>
                ...
                <div>
                    ...
                    <input
                        ...
                        name="password"
                        class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 focus:outline-none shadow-sm transition"
                        placeholder="Use the one you won't forget"
                        required
                    />
                </div>
                ...
                <div class="flex items-center">
                    <input
                        ...
                        id="terms"
                        name="terms"
                        class="w-5 h-5 text-blue-500 focus:ring-blue-400 border-gray-300 rounded"
                        required
                    />
                ...
                <!-- Login Link -->
                <div
                    class="mt-4 text-center flex items-center justify-center gap-2"
                >
                    <p>Have an account?</p>
                    <a
                        href="{{ route("login") }}"
